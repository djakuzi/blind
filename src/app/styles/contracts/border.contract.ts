...
export const BORDER_WIDTH_TOKENS = ['none', 'thin', 'medium', 'thick', 'heavy'] as const;
...
export type tBorderStyleValue = tBorderStyleToken | 'dotted' | 'double' | 'none' | 'inherit' | 'initial' | 'unset' | (string & {});
