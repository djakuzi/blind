...
export const PALETTE_COLOR_TOKENS = ['blind-black', 'blind-white', 'blind-red'] as const;
...
export const BORDER_COLOR_TOKENS = ['border-subtle', 'border-default', 'border-strong', 'border-contrast'] as const;

export const TEXT_COLOR_TOKENS = ['text-primary', 'text-secondary', 'text-tertiary', 'text-disabled'] as const;

export const ICON_COLOR_TOKENS = ['icon-primary', 'icon-secondary', 'icon-muted', 'icon-disabled', 'icon-accent'] as const;
...
export type tColorToken =
  tPaletteColorToken | tBrandColorToken | tSurfaceColorToken | tBorderColorToken | tTextColorToken | tIconColorToken | tStatusColorToken;
