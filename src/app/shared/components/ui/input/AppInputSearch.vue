...
const inputStyle = computed(() => ({
  ...
  '--cp-input-search-padding-x': resolvePaddingValue(
    props.paddingX ?? sizeConfig.value.paddingX,
  ),
  '--cp-input-search-padding-y': resolvePaddingValue(
    props.paddingY ?? sizeConfig.value.paddingY,
  ),
  '--cp-input-search-background-color': resolveColorValue(props.backgroundColor),
  '--cp-input-search-text-color': resolveColorValue(
    props.disabled ? 'text-disabled' : props.textColor,
  ),
  '--cp-input-search-placeholder-color': resolveColorValue(
    props.disabled ? 'text-disabled' : props.placeholderColor,
  ),
  ...
  '--cp-input-search-font-size': resolveFontSizeValue(
...
.app-input-search {
  ...
  padding:
    var(--cp-input-search-padding-y)
    var(--cp-input-search-padding-x);
  border:
    var(--cp-input-search-border-width)
    var(--cp-input-search-border-style)
    var(--cp-input-search-border-color);
